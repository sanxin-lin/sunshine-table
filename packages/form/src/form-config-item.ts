...
const VxeFormConfigItem = defineComponent({
  ...
  setup(props) {
    ...
    const renderVN = () => {
      ...
      const titleAsterisk = XEUtils.eqNull(item.titleAsterisk)
        ? allTitleAsterisk
        : item.titleAsterisk;
      const itemOverflow =
            ...
            [
              ...
              h('i', {
                class: [
                  ...
                  collapseAll ? GlobalConfig.icon.FORM_FOLDING : GlobalConfig.icon.FORM_UNFOLDING,
                ],
              }),
            ],
          ),
